<?php
//Create 2 variable to display the value of user email and password in the form input, they are empty by defaults
$Email = "";
$RegistrationId = "";
...
<div class="card" style="margin: 200px auto; width: 500px;">
    <form method="post">
        ...
        <div class="card-body">
            ...
            <div class="input-group mb-3">
                <input type="password" name="registrationId" class="form-control" placeholder="Registration ID"
            ...
            <a href="RegistrationPage.php" style="color: green; margin-left: 20px;">Would you like to travel with us
                ?</a>
        </div>
    </form>
</div>
...
//Check if 2 variable is set or not and declare some variable to connect to the db
...
//Select statement
    ...
    //Set session and declare specific email and password for admin use only
    if (mysqli_num_rows($result) == 0) {
        ...
        //Set session for guest and redirect to user information page
        $_SESSION['User'] = 'Guest';
        $_SESSION['email'] = $Email;
